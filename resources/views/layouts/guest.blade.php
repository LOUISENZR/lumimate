...
<body class="font-['Inter']">
    ...
    <div class="grid grid-cols-2 w-full h-screen overflow-hidden">
        ...
        {{-- RIGHT SIDE --}}
        <div class="flex flex-col bg-[#FAF7F5] px-16 py-10 overflow-y-auto">

            {{-- Tabs --}}
            <div class="flex gap-8 border-b border-[#E0D9D0] mb-6">
                <a href="{{ route('login') }}"
                    class="{{ request()->routeIs('login') ? 'text-[#4A3B6B] border-b-2 border-[#4A3B6B]' : 'text-[#9E9692] border-b-2 border-transparent' }} text-sm tracking-[2px] uppercase pb-4 font-medium">
                    Login
                </a>
                <a href="{{ route('register') }}"
                    class="{{ request()->routeIs('register') ? 'text-[#4A3B6B] border-b-2 border-[#4A3B6B]' : 'text-[#9E9692] border-b-2 border-transparent' }} text-sm tracking-[2px] uppercase pb-4 font-medium">
                    Register
                </a>
            </div>
            ...
            {{-- Heading --}}
            <div class="mb-6">
                <h1 class="text-[48px] leading-none tracking-[-2px] text-[#3B2F5E] font-bold font-['Bodoni_Moda']">
                    {{ request()->routeIs('login') ? 'Welcome Back' : 'Create Account' }}
                </h1>
                <p class="mt-3 text-[16px] text-[#5C5070]">
                    {{ request()->routeIs('login') ? 'Resume your skin ritual journey.' : 'Begin your skin ritual journey.' }}
                </p>
            </div>
            ...
            {{-- Footer --}}
            <div class="flex items-center justify-between pt-6 text-sm text-[#B0AAA4]">
                <p>LUMIMATE © 2026</p>
